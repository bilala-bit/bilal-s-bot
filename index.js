...
const chalk = require('chalk');
  ...
  bot.user.setActivity("+help - D'Gen alors ça genere fort");
});
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                ...
                const embed = {
                    ...
                    footer: {
                        icon_url:
                            "https://media.discordapp.net/attachments/1020683291289989160/1022684811082596372/standard_4.gif",
                        text: "Développé par el_bilxl"
                    },
                    image: {url:"https://media.discordapp.net/attachments/1020683291289989160/1022684811082596372/standard_4.gif"},
                    author: {
                        name: botname + " - générateur de compte",
                        url: "https://discord.gg/akbjxzAxeg",
                        ...
                        if (position != -1) {
                            ...
                            fs.writeFile(filePath, data, function (err) {
                                const embed = {
                                    ...
                                    timestamp: new Date(),
                                    footer: {
                                        icon_url: "https://imgur.com/X1QIYyS.gif",
                                        text: "Développé par el_bilxl"
                                    },
                                    image: {
                                        url:
                                            "https://imgur.com/X1QIYyS.gif"
                                    },
                                    author: {
                                        name: botname + " - générateur de compte",
                                        url: "https://discord.gg/akbjxzAxeg",
            ...
            if (command === "help") {
                ...
                const embed = {
                    ...
                    footer: {
                        text: 'Développé par el_bilxl',
                        icon_url: 'https://media.discordapp.net/attachments/1020683291289989160/1022684811082596372/standard_4.gif',
                    },
                };
                message.channel.send({ embed });
            }
